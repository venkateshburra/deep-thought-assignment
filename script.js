     ...
     <article class="cards">
        ...
        <div>
          <a href="https://www.youtube.com/watch?v=TiMRwri1xJ8" target="_blank">
            <img class="youtube_video" src="image 13.png" alt="Click to play video"">
          </a>
        </div>
       </article> 
      `;
     ...
     <article class="cards">
      ...
      <div class="structure_div">
        ...
        <div class="allItems">
          ...
          <div class="allImages">
            <img src="arrow-curve-left-right.png" alt="">
            <img src="arrow-curve-left-down.png" alt="">
            <img src="arrow-expand-02.png" alt="">
            <p>Paragraph</p>
            <img class="dot" src="more.png" alt="">
          </div>
        </div>
      </div>
      <div class="textField">
